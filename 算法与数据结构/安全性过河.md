...
public static class State {
        int[] action= new int[2];              // 导致当前状态的动作，初始的动作即为[3,3]
...
public class CrossRiver {
    ...
    public static class State {
        ...
        public State(int[] states) {
            states = states.clone();
            this.state[0] = states[0];
            this.state[1] = states[1];
            this.state[2] = states[2];
            this.state[3] = states[3];
            this.state[4] = states[4];
            this.action = new int[]{3,3};
        }
