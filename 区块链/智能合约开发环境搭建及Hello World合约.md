...
使用remix-ide命令启动remix-ide，在浏览器中查看[本地地址](http://localhost:8080)，便可以使用本地的remix-ide了。

![](https://img-blog.csdnimg.cn/20190325204946244.png)

### geth 安装

[安装指引](https://github.com/ethereum/go-ethereum/wiki/Building-Ethereum)
...
![](https://img.learnblockchain.cn/2017/open_geth_eth.jpg)
...
把这段代码写(拷贝)到Browser-Solidity，如果没有错误，点击 Details 获取部署代码。  
